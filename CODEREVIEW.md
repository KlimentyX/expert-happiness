...
-   <a id="hh-review-github-pr"></a>Ревью проходит в формате [пулл-реквестов](https://help.github.com/articles/using-pull-requests/) на Гитхабе. [¶](#hh-review-github-pr)
...
-   <a id="hh-review-api"></a>Продуманный дизайн API, где API — это любой модуль с внешним интерфейсом. [¶](#hh-review-api)
...
-   <a id="hh-review-format"></a>Форматирование кода делайте отдельным коммитом _до_ основных изменений, или даже отдельным пулл-реквестом. [¶](#hh-review-format)
...
-   <a id="hh-review-suggest"></a>Не _требуйте_, а _предлагайте_ внести изменения. [¶](#hh-review-suggest)
